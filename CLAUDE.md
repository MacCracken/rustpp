...
- **Compiler**: 302KB (x86_64), self-hosting, multi-width types, sizeof, unions, bitfields, defer, expression-position comparisons, `#assert`, Str/cstr auto-coercion, string interning, syscall arity warnings, `#derive(accessors)`, native multi-return, switch case blocks
