...
run_example "exit42"    "archive/stages/examples/exit42.cyr"    42
run_example "mem"       "archive/stages/examples/mem.cyr"       42
run_example "mem_rsp"   "archive/stages/examples/mem_rsp.cyr"   42
run_example "mem_disp"  "archive/stages/examples/mem_disp.cyr"  42
echo ""

echo "-- Byte-Exact: Stage Compilers --"
run_byte_exact "stage1a" "archive/stages/stage1a.cyr"
run_byte_exact "stage1b" "archive/stages/stage1b.cyr"
run_byte_exact "stage1c" "archive/stages/stage1c.cyr"
run_byte_exact "stage1d" "archive/stages/stage1d.cyr"
run_byte_exact "stage1e" "archive/stages/stage1e.cyr"
run_byte_exact "stage1f" "archive/stages/stage1f.cyr"
echo ""

echo "-- Bootstrap Closure --"
echo -n "  "
cat archive/stages/stage1f.cyr | "$ASM" > /tmp/cyr_sf_$$ 2>/dev/null
cat archive/stages/stage1f.cyr | "$SEED_ASM" > /tmp/cyr_seed_sf_$$ 2>/dev/null
