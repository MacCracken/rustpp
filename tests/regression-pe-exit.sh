...
#   - CYRIUS_V5626_SHIPPED not set (pre-fix).
set -e
...
if [ -z "$CYRIUS_V5626_SHIPPED" ]; then
    echo "  skip: pin v5.6.26 — Windows 11 24H2 PE syscall(60,42) exits 0x40010080 not 42 (see docs/development/roadmap.md §v5.6.26)"
    exit 0
fi
