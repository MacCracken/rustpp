...
| 4 | **`break` in deeply nested while/if** | agnostik, json.cyr | **Open** — multi-break array (3.3.9) reverted in 3.3.15 due to libro regression. Single-slot break restored. Stdlib workaround (flag vars) still needed. |
